    ...
    <div className="bg-[#121212]  flex gap-5 flex-col rounded-xl  mt-5 max-h-1/2 ">
      <div className="flex max-h-96 no-scrollbar gap-5  flex-col  overflow-auto">
        ...
        {data?.map((Reply: RepliesType): ReactNode => {
          ...
          return (
            <div key={Reply.id} className="ml-4 py-5 px-4  shadow-[1px_2px_5px_1px_rgba(0,0,0,0.7)] shadow-black/45 text-white flex flex-col   rounded-md">
              <div className="text-sm py-1 flex gap-3  items-center">
                ...
                <ThumbsUp className="opacity-90" color="white" />
